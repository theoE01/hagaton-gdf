# chat_routes.py (COMPATÍVEL com SQLite + SQLAlchemy)
...
def chat_enviar():
    ...
    messages = [{
        ...
        "content": (
            ...
            "Ajude o usuário com orientações e registre solicitações de forma clara. "
            "Quando houver anexos, peça descrição do que analisar no arquivo."
        )
    }]
